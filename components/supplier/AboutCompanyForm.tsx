...
import { Building2, Image as ImageIcon, Phone, Save } from "lucide-react";
        ...
        <div className="flex items-center gap-4">
          {logoUrl ? (
            ...
            <img
              src={logoUrl}
              alt=""
              className="h-14 w-14 rounded-2xl object-cover border border-border-primary"
            />
          ) : (
            <div
              className="grid h-14 w-14 place-items-center rounded-2xl text-xl font-extrabold"
              style={{
                background:
          ...
          <label className="flex-1 flex flex-col gap-1.5">
            ...
            />
            <span className="text-xs text-text-secondary">
              {t(locale, "profile_field_logo_help")}
            </span>
          </label>
        </div>
      </section>
